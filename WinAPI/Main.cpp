...
CONST CHAR gsz_LOGIN_INVITATION[] = "Введите имя пользователя"; // gsz - dlobal string zero (именованный null terminated line)
...
BOOL CALLBACK DlgProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:	// для создания элементов окна
	{
		...
		//Получаем обработчики окна текстовых полей (HWND - handler to window, или обработчик окна)
